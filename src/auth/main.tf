// This file is used to create the user assigned identity and assign the necessary roles to the identity
// Some code, was written as part of this excellent blog: https://dev.to/willvelida/deploying-to-azure-with-terraform-and-github-actions-5191
